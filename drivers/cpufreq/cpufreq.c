...
int cpufreq_register_driver(struct cpufreq_driver *driver_data)
{
	...
	min_freq_hardlimit[0] = CONFIG_CPU_FREQ_MIN_PWRCLUSTER;
	max_freq_hardlimit[0] = CONFIG_CPU_FREQ_MAX_PWRCLUSTER;
	min_freq_hardlimit[1] = CONFIG_CPU_FREQ_MIN_PERFCLUSTER;
	max_freq_hardlimit[1] = CONFIG_CPU_FREQ_MAX_PERFCLUSTER;
